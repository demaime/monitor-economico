  ...
  return (
    <section className="bg-gray-700">
      ...
      <div className="w-full h-[90%] text-white center-flex-col">
        ...
        <div className="border-y-2 border-[#FF5733] w-[90%] h-[80%] flex flex-col items-center overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:bg-[#FF5733] [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-700">
        ...
        <div className="w-full h-[10%] center-flex">
